...
// Test case types
export type TestCaseType = 'content' | 'style' | 'layout' | 'interaction' | 'animation' | 'media';
...
// Test Types
export type TestProperty = ContentProperty | StyleProperty | MediaProperty;
...
export interface ImageTestConfig extends MediaTestConfig {
  allowedFormats?: ('webp' | 'avif' | 'png' | 'jpg')[];
  minDimensions?: {
    width: number;
    height: number;
  };
...
export interface VideoTestConfig extends MediaTestConfig {
